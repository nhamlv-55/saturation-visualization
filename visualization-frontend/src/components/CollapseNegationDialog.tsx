...
class CollapseNegationDialog extends React.Component<Props, State> {
    state = {
        source: "",
        target: "",
        regex: false,
    ...
    render() {
        ...
        return (
            <div>
                {`CollapseNegation: `}<input type="text" defaultValue=""onChange={(e)=> {this.setState({source: e.target.value})}} />
...
export default CollapseNegationDialog;
