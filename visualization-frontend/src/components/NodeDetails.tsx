        ...
        if (node.event_type === "EType.EXP_POB") {
            ...
            if (node.exprID in this.props.PobLemmasMap){
                ...
                for (const lemma of lemmas){
                    ...
                    console.log(this.state.transformedExprMap);
                    if (Object.keys(this.state.transformedExprMap).length !== 0 && lemma[0] in this.state.transformedExprMap) {
                        lemma_list.push(<pre>{this.state.transformedExprMap[lemma[0]]['Edited']}</pre>);
                    }
                        ...
                        let exprList = getCleanExprList(this.props.ExprMap[lemma[0]].edited, "\n");
